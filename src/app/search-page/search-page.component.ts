...
export class SearchPageComponent implements OnInit {
  ...
  ngOnInit() {
    const foundMoviesSelector = createSelector(
      selectFavoriteMovies,
      selectSearchResult,
      selectWatchedMovies,
      (favoriteList: Array<IMovie>, searchResult: ISearchResult, watchedList: Array<IMovie>) => {
    ...
    this.moviesToShowPrepared$ = this.store.select(foundMoviesSelector);
